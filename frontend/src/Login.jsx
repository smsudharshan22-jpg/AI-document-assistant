  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 bg-white bg-opacity-10 rounded-3xl p-8 mb-10 w-full max-w-sm">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="bg-white bg-opacity-20 rounded-2xl rounded-tl-none p-4 flex-1">
              <p className="text-white text-sm">Hi! I've analyzed your document. What would you like to know?</p>
            </div>
          </div>
          <div className="flex items-start gap-4 justify-end">
            <div className="bg-purple-500 bg-opacity-60 rounded-2xl rounded-tr-none p-4 flex-1">
        ...
        <h2 className="relative z-10 text-white text-3xl font-bold text-center mb-4">AI Document Assistant</h2>
        <p className="relative z-10 text-purple-200 text-center text-base max-w-xs">Upload your PDF and ask anything. Get instant answers from your documents with AI.</p>
        <div className="relative z-10 flex gap-8 mt-10">
          <div className="text-center"><p className="text-white text-2xl font-bold">10K+</p><p className="text-purple-200 text-xs">Documents</p></div>
          <div className="text-center"><p className="text-white text-2xl font-bold">50K+</p><p className="text-purple-200 text-xs">Questions Asked</p></div>
          <div className="text-center"><p className="text-white text-2xl font-bold">99%</p><p className="text-purple-200 text-xs">Accuracy</p></div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={remember} onChange={e => setRemember(e.target.checked)} className="w-4 h-4 accent-purple-600" />
                  <span className="text-sm text-gray-600">Remember me</span>
                </label>
                <button type="button" onClick={() => alert("Forgot password coming soon!")}
                  className="text-sm text-purple-600 hover:underline font-medium">Forgot password?</button>
              </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <button onClick={onGoSignup} className="text-purple-600 font-semibold hover:underline">Sign up</button>
            </p>
          </div>
        </div>
      </div>
